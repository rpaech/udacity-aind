# Modified version of run_match.py that uses signals rather than
# multi-threading to implement timeout of turns.
# Sourced from https://github.com/JamesMcGuigan/udacity-artificial-intelligence/blob/master/Projects/3_Adversarial%20Search/run_match_sync.py
